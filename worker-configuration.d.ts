/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2043826426c9f6763b31f58a86e68de)
// Runtime types generated with workerd@1.20250913.0 2025-05-09 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		lokiHost: "https://loki-observation.bud-infra-europe-west2.thisisbud.com/cloudflare-worker-logs/loki/api/v1/push";
		ca_cert: string;
		tls_cert: string;
		tls_key: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "lokiHost" | "ca_cert" | "tls_cert" | "tls_key">> {}
}
